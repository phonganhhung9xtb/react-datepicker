...
var u = e(require("date-fns/subDays")),
  ...
  O = e(require("date-fns/setQuarter")),
        ...
        return (
          ...
          se(he((r = n.call(this, e))), "renderOptions", function() {
            return r.state.monthYearsList.map(function(e) {
              var n = S(e),
                a = xe(r.props.date, e) && Ye(r.props.date, e);
              return t.createElement(
                "div",
                {
                  className: a
    ...
    function n() {
      ...
      return (
        ...
        se(he(e), "onChange", function(t) {
          e.toggleDropdown();
          var r = ke(parseInt(t));
          (xe(e.props.date, r) && Ye(e.props.date, r)) || e.props.onChange(r);
        }),
        se(he(e), "toggleDropdown", function() {
          return e.setState({ dropdownVisible: !e.state.dropdownVisible });
        }),
    ...
    function a() {
      ...
      return (
        ...
        se(he(e), "onQuarterClick", function(t, r) {
          e.handleDayClick(Oe(O(e.props.day, r)), t);
        }),
    ...
    function n(e) {
      ...
      return (
        ...
        se(he(t), "onYearClick", function(e, r) {
          var n;
          t.handleYearClick(((n = x(t.props.date, r)), B(n)), e);
        }),
        t
      );
    }
      ...
      return (
        ...
        se(he(s), "onInputKeyDown", function(e) {
          ...
          if (s.state.open || s.props.inline || s.props.preventOpenOnFocus) {
            if (s.state.open) {
              ...
              "Enter" === t
                ? (e.preventDefault(),
                  s.inputOk() && s.state.lastPreSelectChange === Ot
                    ? (s.handleSelect(n, e),
        ...
        se(he(s), "onDayKeyDown", function(e) {
          ...
          if ("Enter" === t)
            ...
            e.preventDefault(),
              s.setState({ lastPreSelectChange: Ot }),
